...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#tambahPengurus"><i class="fa fa-plus-square" aria-hidden="true"></i> Tambah</a>

            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Pengurus Perumahan Graha Absolut Pereng Wetan</h6>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered  table-striped" id="dataTable" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" scope="col">Masa Jabatan</th>
                                    <th class="text-center" scope="col">Tgl Awal Jabatan</th>
                                    <th class="text-center" scope="col">Tgl Akhir Jabatan</th>
                            ...
                            <tbody id="table">
                                ...
                                foreach ($main as $m) : ?>
                                    <tr>
                                        ...
                                        <td class="text-left" scope="col"><?= @$m['jabatan'] ?></td>
                                        <td class="text-left" scope="col"><?= @$m['masa_jabatan'] ?></td>
                                        <td class="text-left" scope="col"><?= to_date(@$m['tgl_awal_jabatan'], '', 'date') ?></td>
                                        <td class="text-left" scope="col"><?= to_date(@$m['tgl_akhir_jabatan'], '', 'date') ?></td>
...
<!-- End of Main Content -->
<!-- Tambah -->
<div class="modal fade" id="tambahPengurus" tabindex="-1" aria-labelledby="tambahPengurusModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="tambahPengurusLabel">Menambah Pengurus Baru</h5>
            </div>
            <form method="POST" id="save_pengurus">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="save_pengurus">Tambah</button>
                </div>
            </form>
        </div>
    </div>
