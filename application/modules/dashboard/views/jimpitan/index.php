        ...
        <div class="modal-content">
            ...
            <form method="POST" id="save_jimpitan">
                <div class="modal-body">
                    ...
                    <!-- <div class="mb-3">
                        <select class="custom-select custom-select-sm form-control" id="transaksi_id" name="transaksi_id"> 
                    ...
                    <div class="mb-3">
                        ...
                        <input type="hidden" class="form-control" id="transaksi_id" name="transaksi_id" value="001">
                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                        <span class="text-danger ">
