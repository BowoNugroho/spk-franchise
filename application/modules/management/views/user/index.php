                            ...
                            <tbody id="table">
                                ...
                                foreach ($main as $m) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center" scope="col"><?= @$m['user_nm'] ?></td>
            ...
            <form method="POST" id="save_user">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="user_nm" name="user_nm" placeholder="Nama User">
                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                        <span class="text-danger ">
                            <strong id="user_nm_error"></strong>
                        </span>
                    </div>
                    <div class="mb-3">
                ...
                success: function(data) {
                    ...
                    if (data.error) {
                        ...
                        if (data.menu_error != '') {
                            ...
                            $('#user_nm_error').html(data.user_nm_error);
        ...
        $('.btn-edit').bind('click', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('input[name="user_nm"]').val(response.user_nm);
